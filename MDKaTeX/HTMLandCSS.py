...
HTMLforEditor = file_to_string(path_relative_to_this_file("js/HTMLforEditor.js"))
...
front_cloze = file_to_string(path_relative_to_this_file("html/front_cloze.html"))
